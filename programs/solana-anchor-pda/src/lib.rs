...
declare_id!("GjY9K7So8pnfVjQJsf24fwjCcRYasz3F3hC8V8DEMswg");

#[program]
pub mod solana_anchor_pda {
    use super::*;
...
pub struct CreateLedger<'info> {
    #[account(init, payer = wallet, space = 82, seeds = [wallet.key().as_ref(), b"_", color.as_ref(),], bump)]
